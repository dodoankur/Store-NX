...
To start, You need to have cli, `yarn global add nx` or `npm i -g nx`
...
To start the store, `yarn webpack:store` `yarn webpack:store:server`
`yarn start-store`

To setup database, `yarn setup`
