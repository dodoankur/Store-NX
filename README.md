...
you can first start server with,
`nx run server:serve`
...
Libraries are sharable across libraries and applications. They can be imported from `@store/mylib`.
