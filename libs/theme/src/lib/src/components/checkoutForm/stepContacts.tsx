...
const CheckoutStepContacts = props => {
  ...
  function setInitialValues() {
    ...
    if (Lscache.get("auth_data") !== null) {
      props.initialize({
        first_name: props.customerProperties.customer_settings.first_name,
    ...
    // props.change("input", {disabled: true});
  }
