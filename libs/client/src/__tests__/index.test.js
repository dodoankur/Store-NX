import CezerinClient from "../test"
...
const ajaxCredentials = {
  ajaxBaseUrl: "/ajax",
}

test("api structure", () => {
  const api = new CezerinClient(apiCredentials)
...
test("ajax structure", () => {
  const api = new CezerinClient(ajaxCredentials)
...
test("static methods", () => {
  expect(typeof CezerinClient.authorize).toBe("function")
  expect(typeof CezerinClient.authorizeInWebStore).toBe("function")
})
